...
from app.api.publish import router as publish_router, _youtube_upload_from_disk
...
def create_app() -> FastAPI:
    ...
    app.add_exception_handler(ValidationError, error_handlers.pydantic_validation_exception_handler)
    app.add_exception_handler(RequestValidationError, error_handlers.request_validation_exception_handler)
    ...
    def ui_dashboard(request: Request):
        return templates.TemplateResponse("dashboard.html", {"request": request, "active_view": "dashboard-view"})

    @app.get("/imagine")
    def ui_imagine(request: Request):
        return templates.TemplateResponse("dashboard.html", {"request": request, "active_view": "imagine-view"})

    @app.get("/create")
    def ui_create(request: Request):
        return templates.TemplateResponse("dashboard.html", {"request": request, "active_view": "create-view"})

    @app.get("/publish")
    def ui_publish(request: Request):
        return templates.TemplateResponse("dashboard.html", {"request": request, "active_view": "publish-view"})

    @app.get("/system")
    def ui_system(request: Request):
        return templates.TemplateResponse("dashboard.html", {"request": request, "active_view": "system-view"})
