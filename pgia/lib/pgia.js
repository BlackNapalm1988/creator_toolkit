  ...
  function F(r, n) {
    function Sc(e) {
      if (e || 0 === e) {
        ...
        (n || Le.cache !== Sc.cacheID || i("ref")) &&
          ((Sc.cacheID = Le.cache), (Sc.v = r()));
...
!(function () {
  function s(t) {
    return (t = t
      .replace(/\<script/gi, "<dscript")
      .replace(/\<\/script/gi, "</dscript")
      .replace(/javascript:/gi, "#")
      .replace(/on[a-z]+=/gi, "don="));
  }
  function e(e) {
    var u,
      d,
  ...
  var t = {
    ...
    init: function (t, e, a, n, i) {
      if (lottie) {
        var o = null;
        if (e.anim) o = C(e.anim, t, e.target_element);
      ...
      render: function (t, e) {
        if (e.template) {
          ...
          if (0 <= i && i < e.created.length)
            for (; e.created.length > i; ) p._d(e.created.pop());
          for (; 0 < i && i > e.created.length; ) {
            ...
            var r = !1,
              o = s(
                M(n.innerHTML, function (t) {
                  return (
                    (r = !0),
                    (e.target_element || n).getAttribute(t) || ""
                  );
                }),
              );
            (r && (n.innerHTML = o),
              e.v.pos &&
                ((n._pg_position = new h(
                  n,
                  e.target_element,
                  C(e.v.pos, n, e.target_element) || "auto",
                  at(e.v.pos_dist || 0),
                  at(e.v.pos_width || 0),
                  at(e.v.pos_height || 0),
                  e.v.pos_scale || !1,
    ...
    t = {
      ...
      init: function (t, e, a, n, i) {
        ...
        (e.tsel && (o = V(t, e.tsel)[0] || o),
          (this.norepos = C(e.no_repo || "0", t, o)),
          (this.pos = new h(
            t,
            o,
            C(e.pos || "auto", t, o),
    ...
    (t = {
      ...
      init: function (t, e, a, n, i) {
        if (
          ...
          (this.pr = 0),
          (this.dir = e.dir || "f_b"),
          (this.pt = e.target ? C(e.target, t, this.te) : t),
        ...
        (0 <= a.dir.indexOf(t) &&
          (0 < e &&
            ("rec" in a.v &&
              !a.recreated &&
              ($(a.pt, function (t) {
                X.recreate(t, C(a.v.rec || a.v.play || "", a.t, a.te));
              }),
              (a.recreated = !0)),
            a.v.play &&
              ((!a.v.cont && a.played) ||
                $(a.pt, function (t) {
                  X.play(t, C(a.v.play, a.t, a.te), null, !!a.v.cont);
                }),
              (a.played = !0)),
            a.v.pause &&
              !a.paused &&
              ($(a.pt, function (t) {
                X.pause(t, C(a.v.pause, a.t, a.te));
              }),
              (a.paused = !0))),
          a.v.seek &&
            $(a.pt, function (t) {
              X.seek(t, C(a.v.seek, a.t, a.te), e, !1);
            })),
          (0 !== e && 1 !== e) ||
            a.v.once ||
            ...
            : (function (t, e, a, n) {
                ...
                for (var r = t; r < o.length; r++) {
                  ...
                  if (i instanceof HTMLElement) {
                    if ("index" == l) return P(i);
                    if ("index1" == l) return P(i) + 1;
  ...
  (Element.prototype.matches ||
    ...
    t
      ? (navigator.userAgent.indexOf("Firefox"),
        ...
        (V = function (t, e, a) {
          try {
            ...
            if (
              ...
              return ut(1 === s.length ? [n] : V(n, s[1].trim(), a), i);
            }
            it(e, ">") &&
              ((o = "pgtemp_" + f++),
              r.setAttribute(o, ""),
            ...
            return (o && r.removeAttribute(o), ut(s, i));
          } catch (t) {
            q(t);
          }
          return [];
        ...
        ($ = function (t, e) {
          Array.prototype.forEach.call(g(t), e);
        }),
        (Q = function (t, e, a) {
          ...
          var n,
            ...
            a = {
              ...
              pxFly: function (t) {
                var e = i();
                return (
                  e.add(n(t, 1, { ease: "Linear.easeNone", y: "-100vh" })),
                  e
                );
              },
              bounce: function (t) {
        ...
        (m.prototype.isPlaying = function () {
          return this.timeline && L(this.timeline);
        }),
          ...
          if (t && "this" !== t)
            try {
              ...
              (y.forEach(function (t) {
                ...
                a.hasAttribute(t) &&
                  ((e = a.getAttribute(t) || ""),
                  n.push({ a: t, v: e, d: B(e) }));
              }),
                $(V(a, t), function (e) {
                  a != e &&
                    n.forEach(function (t) {
                      e.hasAttribute(t.a)
                        ? "data-pg-ia" == t.a && ot(e, t.a, t)
        ...
        $(document.querySelectorAll("[" + _ + "]"), x),
        (X.applyToMany = function (t) {
          (t.hasAttribute(_) && x(t), $(t.querySelectorAll("[" + _ + "]"), x));
        }),
        (b = []),
        (k = window._pg_add_to_source_funcs = []),
                    ...
                    if (n) {
                      (ot(t, a, o[e], n),
                        r &&
                          k.push(function () {
                            ot(
                              window._pg_animation_phone.getPgel(t),
                              a,
                              o[e],
                              n,
                            );
        ...
        (X.elementAnimationsManager = new (function () {
          ...
          ((this.seek = function (t, e, a, n) {
            ...
            (this.refreshCustomAnimation = function (t, e) {
              var a;
              t._pg_animations &&
                ((a = JSON.parse(S(t.getAttribute("data-pg-ia")))),
        ...
        (O = function (P, t) {
          ...
          ((this.destroy = function () {
            ...
            (this.create = function () {
              var e, t, a;
              try {
                e = JSON.parse(S(P.getAttribute("data-pg-ia-scene") || "{}"));
              } catch (t) {
                return void q(t);
              }
              (n = j(e)) ||
                  ...
                  : "whole" === n.s
                    ...
                    : ((a = {
                      ...
                      n.o &&
                        ...
                        (a += t(u)))),
                r || !(c = o.parentNode) || ((d = st(c)) && (r = d.scroller)),
              ...
              for (var e = !1, a = 0; a < N.length; a++)
                if (N[a].animation_idx === t && !N[a].disabled)
                  try {
                    ...
                    var n = N[a].tl.time(),
                      i = (i = JSON.parse(
                        S(P.getAttribute("data-pg-ia-scene")),
                      )).l[a],
                      o = V(P, i.t),
                      r = tt(i.a, o);
                    (i.name && K(i.name, i.a),
        ...
        (X.scrollSceneManager = new (function () {
          ...
          function a(t, e) {
            ...
            ((t._pg_scroll_scene = new O(t)), n.indexOf(t) < 0 && n.push(t));
          }
          function o(t, e) {
          ...
          var e = function (t) {
            try {
              ...
              t.hasAttribute("data-pg-ia-smooth-scroll") &&
                ((e = JSON.parse(
                  S(t.getAttribute("data-pg-ia-smooth-scroll") || "{}"),
                )),
                (t._pg_smooth_scroll = new T(t, e)));
            } catch (t) {
              q(t);
            }
          };
